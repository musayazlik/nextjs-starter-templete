						...
						{[
							{
								...
								title: "Modern Stack",
								description:
									"Next.js 14, TypeScript, and Tailwind CSS for robust development",
							},
							{
								icon: Puzzle,
							...
							<div
								key={index}
								className="group p-6 rounded-xl border bg-card transition-all hover:shadow-md hover:scale-[1.02]"
							>
